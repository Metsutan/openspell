...
function buildCspHeaderValue(nonce) {
    ...
    const directives = [
        ...
        `img-src 'self' data: blob: *.imgur.com ${httpScheme}://${WEB_HOSTNAME}:${PORT} https://www.gstatic.com ${httpScheme}://${CDN_HOSTNAME} ${httpScheme}://${CDN_HOSTNAME}:*`,
        `object-src 'none'`,
        `script-src 'self' www.google.com www.gstatic.com *.imgur.com https://cdn.jsdelivr.net *.openspell.dev ${httpScheme}://${CDN_HOSTNAME} ${httpScheme}://${CDN_HOSTNAME}:* 'unsafe-eval'${nonceValue}`,
